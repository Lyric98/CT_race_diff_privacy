...
load('merged_pm_denom_cov_data.RData')  # 209876*15
...
###################################################################################################
## 3. use the function to create 5-year mortality rates with each set of population denominators ##
###################################################################################################
...
pmrate_list<-list(pmrate_ce_5yr,pmrate_acs_5yr[,-3],pmrate_dp_5yr[,-3])
