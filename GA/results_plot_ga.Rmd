...
load("./sim/results/fitted_value20.RData")
...
load("./sim/results/fitted_value1.RData")
...
#### MAPE0527 plot
load('./sim/bw_adat5.RData')
adat <- cbind(adat, mape_ij_dp20)[,c(1, 2, 9)] #2877*4
