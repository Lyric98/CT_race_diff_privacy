...
percent_5_source <- cbind(mean(w$exp_counts_ce==0), mean(w$exp_counts_dp==0),mean(w$exp_counts_dp0527==0), mean(w$exp_counts_dp22==0), mean(w$exp_counts_dp0825==0), mean(b$exp_counts_ce==0), mean(b$exp_counts_dp==0),mean(b$exp_counts_dp0527==0),mean(b$exp_counts_dp22==0),mean(b$exp_counts_dp0825==0))%>% rbind(cbind(mean(w$exp_counts_ce<5), mean(w$exp_counts_dp<5),mean(w$exp_counts_dp0527<5),mean(w$exp_counts_dp22<5),mean(w$exp_counts_dp0825<5), mean(b$exp_counts_ce<5), mean(b$exp_counts_dp<5),mean(b$exp_counts_dp0527<5),mean(b$exp_counts_dp22<5),mean(b$exp_counts_dp0825<5)))
...
colnames(percent_5_source) <- c("DC", "DP19", "DP20","DP22","DP2208", "DC", "DP19","DP20","DP22", "DP2208")
...
summary_text <- adat %>% mutate(diff19 = exp_counts_dp-exp_counts_ce) %>% mutate(diff20 = exp_counts_dp0527-exp_counts_ce)%>% mutate(diff22 = exp_counts_dp22-exp_counts_ce) %>% mutate(diff0825 = exp_counts_dp0825-exp_counts_ce)
...
summary_dp_minus_dc <- rbind(huizong2(diff19_w), huizong2(diff19_b),huizong2(diff20_w), huizong2(diff20_b),huizong2(diff22_w), huizong2(diff22_b),huizong2(diff0825_w), huizong2(diff0825_b))
